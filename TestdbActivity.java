...
public class TestdbActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //create and retrieve a Reservation
         ...
         TextView reservations_testdb = findViewById(R.id.reserve_testdb);
         if (reserves.size() >= 1) reservations_testdb.setTextColor(Color.GREEN);
        ...
        // create and retrieve LogRecord
         ...
         TextView records_testdb = findViewById(R.id.logrec_testdb);
         if (records.size() >= 1) records_testdb.setTextColor(Color.GREEN);
    }
